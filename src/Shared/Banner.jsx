...
const Banner = ({children}) => {
    return (
        <div className="relative mb-28">
            ...
            <div className='absolute top-0 rounded-xl w-full h-full bg-gradient-to-r from-[#000000] to-[#15151500]'>
                <h3 className='absolute left-10 top-[44%] text-4xl font-bold'>{children}</h3>
